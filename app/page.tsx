  ...
  return (
    <div className="min-h-screen bg-lighthouse-blue flex flex-col items-center justify-center p-4 overflow-hidden">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
        <h1 className="text-3xl sm:text-4xl font-display text-lighthouse-gold text-center mb-6">
          LIGHTHOUSE
        </h1>
        ...
        {showInputs && (
          <div className="space-y-6 mb-6">
            <div className="text-center">
              <Label
                htmlFor="sets"
                className="mb-2 block text-lighthouse-gold font-serif text-lg"
              >
                Number of Sets
              </Label>
        ...
        <div
          className={`text-center mb-6 transition-all duration-300 ease-in-out ${
            showInputs ? "" : "scale-150"
          }`}
        >
          <div className="text-6xl sm:text-7xl font-display text-lighthouse-blue mb-2">
            {formatTime(timeLeft)}
          </div>
